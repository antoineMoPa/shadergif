class Gif < ApplicationRecord
  ...
  def gen_video_and_thumb
    ...
    # Create gif video
    `timeout 15 avconv -y -r 10 -i public/gifs/generated/#{filename}-temp-%04d.png -crf 35 public/gifs/generated/#{filename}-vid.mp4`
    `timeout 15 avconv -y -r 10 -i public/gifs/generated/#{filename}-temp-%04d.png -crf 35 public/gifs/generated/#{filename}-vid.ogv`
