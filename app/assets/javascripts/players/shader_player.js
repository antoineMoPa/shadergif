class ShaderPlayer {
	...
	offset_parent(element, offset){
		if(element.offsetParent != null){
			var p = this.offset_parent(element.offsetParent, offset);
		} else {
	...
	canvas_mousemove(e){
		var c = e.target;
		var offset = this.offset_parent(c, [0,0]);

		var ratio = c.width / c.height;
		var x = ((e.clientX - offset[0]) / c.width - 0.5) * ratio;
		var y = ((e.clientY - offset[1]) / c.width - 0.5 / ratio) * ratio;
